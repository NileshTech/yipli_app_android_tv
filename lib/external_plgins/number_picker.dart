...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle = TextStyle(color: yipliNewBlue);
    TextStyle selectedStyle = TextStyle(color: yipliWhite);
    // themeData.textTheme.subtitle1.copyWith(color: yipliWhite);
...
class _NumberPickerSelectedItemDecoration extends StatelessWidget {
  ...
  bool get isVertical => axis == Axis.horizontal;
}
