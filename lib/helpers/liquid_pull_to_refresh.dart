...
import 'package:flutter_app/widgets/yipli_loader.dart';
...
class LiquidPullToRefreshState extends State<LiquidPullToRefresh>
  ...
  Widget build(BuildContext context) {
    ...
    Color _defaultBackgroundColor = primarycolor;
        ...
        AnimatedBuilder(
          ...
          builder: (BuildContext buildContext, Widget child) {
            return Padding(
              ...
              //Container before loader appears-initial container
              child: Container(
                ...
                height: _value.value * height * 2.2, // 100.0
                // color: color,
                  ...
                  builder: (BuildContext buildContext, Widget child) {
                    return Align(
                      alignment: Alignment(
                        ...
                        (1.0 -
                            (0.36 *
                                _indicatorTranslateWithPeakAnimation.value) -
                            (0.64 * _indicatorTranslateAnimation.value)),
                      ),
                      child: _mode != _LiquidPullToRefreshMode.refresh
                          ? null
                          : Container(
                              child: Center(
                                child: new YipliLoader(
                                  radius: 20,
                                  dotRadius: 8.0,
